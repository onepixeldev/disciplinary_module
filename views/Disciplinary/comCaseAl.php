...
<form id="comDetl" class="form-horizontal" method="post">
    ...
    <div class="form-group">
        <div class="col-md-2"></div>
        <label class="col-md-4 control-label text-left"><b>Date of Committee Appointment</b></label>
    </div>
    <div class="form-group">
        <div class="col-md-2"></div>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <div class="col-md-2"></div>
        <label class="col-md-4 control-label text-left"><b>Recommendation Investigation Committee</b></label>
    </div>
    <div class="form-group">
        <div class="col-md-2"></div>
        <div class="col-md-8">
