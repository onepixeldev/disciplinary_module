<form id="addRpEntFmAFD" class="form-horizontal" method="post">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">Exact Loss Location</label>
        <div class="col-md-10">
            <input name="form[exact_loss_location]" class="form-control" type="text" placeholder="Exact Loss Location">
        </div>
    </div>
