                                ...
                                foreach ($stf_inf as $si) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center col-md-1">
                                            <button type="button" class="btn btn-primary btn-xs select_staff_id" data-ss-code="'.$si->SS_SERVICE_CODE.'" data-ss-desc="'.$si->SS_SERVICE_DESC.'" data-dept-code="'.$si->SM_DEPT_CODE.'" data-dept-desc="'.$si->DM_DEPT_DESC.'"><i class="fa fa-chevron-down"></i> Select</button>
                                        </td>
                                    </tr>
                                    ';
                                }
