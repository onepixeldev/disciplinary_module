<form id="editRpEntFmDisc" class="form-horizontal" method="post">
    ...
    <div class="form-group">
        <label class="col-md-2 control-label">Status Option</label>
        <div class="col-md-10">
            <?php echo form_dropdown('', $sts_list, '', 'class="form-control width-50" id="sts_opt"')?>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-1">
            <button type="button" class="btn btn-warning sts_progress" value="<?php echo $rp_disc_detl->DCM_CASE_ID?>"><i class="fa fa-tasks"></i> Status Progress</button>
        </div>
    </div>
