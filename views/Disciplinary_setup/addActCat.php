<form id="addActCategory" class="form-horizontal" method="post">
    <div class="modal-header btn-primary">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><i class="fa fa-times"></i></span></button>
            <h4 class="modal-title txt-color-white" id="myModalLabel">Add Action Category</h4>
    </div>
    <div class="modal-body">
        <div id="addActCategoryAlert">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary save_ac"><i class="fa fa-save"></i> Save</button>
    </div>
</form>