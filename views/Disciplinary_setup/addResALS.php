<form id="addResALS" class="form-horizontal" method="post">
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary save_als"><i class="fa fa-save"></i> Save</button>
    </div>
</form>